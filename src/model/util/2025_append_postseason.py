...
with open('/home/tmoran/personal/madness/src/model/matchups/2025.json', 'r') as f:
    matchups = json.load(f)

# Read the postseason entries
with open('/home/tmoran/personal/madness/src/model/util/postseason_entries.json', 'r') as f:
...
with open('/home/tmoran/personal/madness/src/model/matchups/2025.json', 'w') as f:
